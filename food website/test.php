...
<section class="food" id="food">
 ...
 <?php
    ...
    while($ans=mysql_fetch_array($sel))
    {
      ...
      //   echo "<span class='ms' >";
      //   echo "<span class='is'><img src=".$ans[0]." height=200 width=200 class=image ></span>" ;
      //   echo "<span class='ds'><P> NAME : <u><input type=text value=".$ans[1]." name=pname class=w ></u></P>";
      //   echo "<P> COMPANY NAME :<u> ".$ans[4]."</u> </P><P> DETAILS : <u>".$ans[3]."</u></P>";
      //   echo "<P> PRICE :<span class='price'><u>".$ans[2]." RS.</u></span></P>";
      //   echo "<span><input type='submit' value='ADD CART' name='sub_home' class='button' ></span></span>";
      //   echo "</span>";
      //   echo "</form>"; 
      echo " <div class='swiper-slide slide' data-name=".$ans[0].">
      <img src=".$ans[1]." alt=''>
      <h3>".$ans[2]."</h3>
      <div class='price'>RS".$ans[3]."</div>
   </div>";

    }
    echo "ghfjfjfjfjfhjfhjfhjfmhfhfjhf";
