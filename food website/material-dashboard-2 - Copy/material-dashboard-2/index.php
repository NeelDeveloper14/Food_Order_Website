          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
               ...
               //  mysql_select_db("food1");
               $sel=mysqli_query($con,"select * from detail  ");
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
               ...
               $con=mysqli_connect("localhost","root","","user");
               //  mysql_select_db("food1");
               $sel=mysqli_query($con,"select * from detail where date(date) = current_date; ");
