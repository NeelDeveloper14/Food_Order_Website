      ...
      <div class="container">
        ...
        <?php
          ...
          if($con) {
            ...
            // $query1="UPDATE 'admin_credentials' SET 'address'='$address.','email'='.$email.','contact_number'='.$contact_number.','pharmacy_name'='.$pharmacy_name.' WHERE 'username'='.$username.' ";
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="pharmacy_name"  type="text" require class="form-control" value="<?php echo $pharmacy_name; ?>" placeholder="pharmacy name" onkeyup="validateName(this.value, 'pharmacy_name_error');" disabled>
