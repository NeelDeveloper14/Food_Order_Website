      ...
      <div class="card m-auto p-2">
        <div class="card-body">
          <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
            <div class="logo">
        			<img src="images/pic.gif" height="200px" class="profile"/>
            ...
            <div class="input-group form-group">
              ...
              <input id="password" type="password" class="form-control" placeholder="password" onkeyup="validate();" required>
        ...
        <div class="card-footer">
          <div class="text-center">
            <a class="text-light" href="#index.html">Forgot password?</a>
          </div>
